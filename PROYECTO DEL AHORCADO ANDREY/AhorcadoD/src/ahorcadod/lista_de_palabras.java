...
//VARIABLES QUE SE UTILIZARAN DURANTE EL PROGRESO DEL PROGRAMA
   private String ñpalabras[];
   private String kpalabras[];
   private String lpalabras[];//ESTA VARIABLE DE TIPO ARREGLO, TENDRA LAS PALABRAS ASIGNADAS POR EL PROGRAMADOR
   ...
   private String palabraac[];//ESTA VARIABLE DE TIPO ARREGLO, SERA LLENADO CON "_" PARA PERMITIR QUE EL USUARIO VEA EL TAMAÑO DE LA PALBRA A ADIVINAR
   ...
   //CONSTRUCTOR DE LA CLASE LISTA_DE_PALABRAS
    ...
    /**
     *MÉTODO QUE SE LLENA CON EL CARACTER "_", ESTO PARA REVELAR LA LONGITUD DE LA PALABRA A ADIVINAR
     * @param palabraac
     */
